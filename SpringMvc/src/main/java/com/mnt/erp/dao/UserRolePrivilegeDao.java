...
public interface UserRolePrivilegeDao {
	...
	public int saveUserRolePriviligeDetails(List<UserRolePrivilege> userRolePrivileges);
	public List<Object[]> searchUserRolePriviligeDetails();
	public List<Object[]> basicSearchUserRolePriviligeDetails(String label, String operator,
			String searchName);
