                                              ...
                                              .validate(
                                                      {
                                                        ...
                                                        messages: {
                                                          bonusType: {
                                                            required: "<font style='color: red;'><b>Bonus Type is Required</b></font>",
...
<body>
	...
	<div class="divUserDefault" id="mainId">
		<div class="PageTitle">Bonus Type</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					<form:form action="searchBonusType.mnt" method="GET"
						commandName="bonusTypeCmd">
						<table class="tableGeneral">
							<tr>
								<td colspan="2"><c:forEach items="${param.list}">
										<div class="alert-success">
											...
											<spring:message code="label.bonusType" />
									...
									</c:forEach> <c:forEach items="${BonusTypeUpdate}">
										<div class="alert-success">
											<strong> <spring:message code="label.success" />
											</strong>
											<spring:message code="label.bonusType" />
									...
									</c:forEach> <c:forEach items="${BonusTypeUpdateFail}">
										<div class="alert-danger">
											<strong> <spring:message code="label.error" />
											</strong>
											<spring:message code="label.bonusType" />
									...
									</c:forEach> <c:forEach items="${BonusTypeDelete}">
									...
									</c:forEach> <c:forEach items="${BonusTypeDeleteFail}">
										<div class="alert-danger">
											<strong> <spring:message code="label.error" />
											</strong>
											<spring:message code="label.bonusType" />
							...
							<tr>
								...
								<td><form:select path="xmlLabel" cssClass="select">
									...
									</form:select> <spring:bind path="bonusTypeCmd.operations">
					...
					<c:if test="${bonusBeans!=null}">
						<display:table id="Row" name="bonusBeans"
							requestURI="searchBonusType.mnt" pagesize="5" class="table">
							<display:column property="bonusType" titleKey="label.bonusType"
							...
							<display:column titleKey="label.edit" style="color:white">
								<c:choose>
									<c:when test="${true}">
										...
										<a
											href="editBonusType.mnt?bonusTypeId=<c:out value="${Row.bonusTypeId}"/>"
							...
							<display:column titleKey="label.delete">
								<c:choose>
									<c:when test="${true}">
										<a
											href="deleteBonusType.mnt?bonusTypeId=<c:out value="${Row.bonusTypeId}"/>"
											style="color: red"
			...
			<div id="tabs-3" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					...
					<form:form action="addBonusType.mnt" id="addForm" method="POST"
						commandName="bonusTypeCmd">
						<table class="tableGeneral">
							...
							<tr>
								<td><spring:message code="label.bonusType" /><span
									class="required">*</span></td>
								<td><form:input path="bonusType" class="textbox" /></td>
							</tr>
			...
			<div id="tabs-1" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					<c:forEach var="AccountEditValues" items="${editvalues }">
						<form:form action="updateBonusType.mnt" method="POST"
							commandName="bonusTypeCmd" id="editForm">
							<table class="tableGeneral">
								...
								<tr>
									<form:hidden path="bonusTypeId" class="textbox" />
								</tr>
								<tr>
									<td></td>
									<td><c:choose>
