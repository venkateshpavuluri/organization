...
<div class="divUserDefault">
		<div class="PageTitle">Defect Class</div>
				...
				<div align="left" class="TabbedPanelsContent">
					...
					<form:form action="searchDefectClass.mnt"
						...
						<table class="tableGeneral">
							<tr>
								<td colspan="2"><c:forEach var="addDefectClassSuccess"
										items="${param.addDefectClassSuccess}">
										<div class="alert-success" id="savemessage">
											<strong>Success!</strong>
											<c:out value="${addDefectClassSuccess}">
											</c:out>
										</div>
									</c:forEach></td>
							</tr>
							<tr>
								<td colspan="2"><c:forEach var="defectUpdate"
										items="${param.defectUpdate}">
										<div class="alert-success" id="savemessage">
											<strong>Success!</strong>
											<c:out value="${param.defectUpdate}">
											</c:out>
										</div>
									</c:forEach></td>
							</tr>
							<tr>
								<td colspan="2"><c:forEach var="defectDelete"
										items="${param.defectDelete}">
										<div class="alert-success" id="savemessage">
											<strong>Success!</strong>
											<c:out value="${param.defectDelete}">
											</c:out>
										</div>
									</c:forEach></td>
							</tr>
							...
							<c:forEach var="defectSearch"
								items="${defectSearch}">
								<c:set var="i" value="${defectSearch}" />
							...
							<tr>
								<td colspan="2"><c:forEach var="addDefectClassDuplicate"
										...
										<div class="alert-warning" id="savemessage">
											<c:out value="${addDefectClassDuplicate}"></c:out>
										</div>
									</c:forEach></td>
							</tr>
