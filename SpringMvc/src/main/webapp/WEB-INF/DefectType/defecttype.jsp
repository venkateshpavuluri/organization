													...
													.validate(
															{
																...
																messages : {
																	defecttype :
																		{
																	required: "<font style='color: red;'><b>Defect Type is Required</b></font>",
...
<script type="text/javascript">
	$(document).ready(function() {
		if (document.getElementById("dthide").value == 1) {
...
<body>
	<div class="divUserDefault">
		<div class="PageTitle"><spring:message code="label.defecttype" /></div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					<form:form action="searchDefectType.mnt" method="GET"
						commandName="DefectType">
						<table class="tableGeneral">
							<tr>
								<td colspan="2"><c:forEach var="defectTypeAdd"
										items="${param.list}">
										<div class="alert-success" id="savemessage">
											<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.defecttype"/> <spring:message code="label.saveSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:if test="${param.listwar!=null }">							
								...
								<spring:message code="label.defecttype"/>	<spring:message code="label.saveFail"/>
										</div>	</c:if>
								<c:forEach var="defectTypeUpdate"
										items="${defectTypeUpdate}">
										<div class="alert-success" id="successmessage">
											<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.defecttype"/> <spring:message code="label.updateSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:forEach var="defectTypeUpdateError"
										items="${defectTypeUpdateError}">
										<div class="alert-danger" id="successmessage">
											<strong><spring:message code="label.error"/></strong>
											<spring:message code="label.defecttype"/> <spring:message code="label.updateFail"></spring:message>
										</div>
									</c:forEach><c:forEach var="defectTypeDelete"
										items="${defectTypeDelete}">
										<div class="alert-success" id="successmessage">
										<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.defecttype"/> <spring:message code="label.deleteSuccess"></spring:message>
										</div>
									</c:forEach><c:forEach var="defectTypeDeleteError"
										items="${defectTypeDeleteError}">
										<div class="alert-danger" id="successmessage">
										<strong><spring:message code="label.error"/></strong>
											<spring:message code="label.defecttype"/> <spring:message code="label.deleteFail"></spring:message>
										</div>
									</c:forEach></td>
							</tr>
							...
							<tr>
								...
								<td><form:select path="xmlLabel" cssClass="select">
									...
									</form:select> <spring:bind path="DefectType.operations">
					...
					<c:if test="${dtbeans!=null}">
						<display:table id="defectid" name="dtbeans"
							requestURI="searchDefectType.mnt" pagesize="5"
							class="table">
							<display:column property="defecttypeid"
								title="Defect Type ID" media="none" sortable="true"></display:column>
							<display:column property="defecttype" title="Defect Type"
								media="html" sortable="true"></display:column>
							<display:column title="Edit" style="color:white">
							<c:choose>
							<c:when test="${edit }">
								<a
									href="defectEdit.mnt?defectedit=<c:out value="${defectid.defecttypeid}"/>"
							...
							<c:when test="${delete}">
								<a
									href="defectDelete.mnt?defectdelete=<c:out value="${defectid.defecttypeid}"/>"
			...
			<div id="tabs-3" class="TabbedPanelsContent">
				...
				<form:form action="saveDefectType.mnt" method="POST"
							commandName="DefectType" id="adddefectform">
					<table class="tableGeneral">

						<tr>
							<td colspan="2"><c:forEach var="dtsuccessdup"
									items="${dtsuccessdup}">
									<div class="alert-warning" id="savemessage">
											<strong><spring:message code="label.warning"/></strong>
											<spring:message code="label.defecttype"/> <spring:message code="label.duplicateCheck"></spring:message>
										</div>
								</c:forEach></td>
						</tr>
						
							<form:hidden path="dthide" />	
							<tr>
							<td><spring:message code="label.defecttype" /><span
									class="required">*</span> <form:input path="defecttype"
			...
			<div id="tabs-1" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					<c:forEach var="InspectionMethodEditValues" items="${editvalues }">
						<form:form action="defectTypeUpdate.mnt" method="POST"
							commandName="DefectType" id="editdefectForm">
							<table class="tableGeneral">
						<tr> <td colspan="2">
						<c:forEach var="dtsuccessdupedit"
									items="${dtsuccessdupedit}">
									<div class="alert-warning" id="savemessage">
											<strong><spring:message code="label.warning"/></strong>
											<spring:message code="label.defecttype"/> <spring:message code="label.duplicateCheck"></spring:message>
										</div>
                                     ...
                                     <%-- <form:hidden path="edthide" /> --%>
								<form:hidden path="edefecttypeid" />
								<tr>
								<td><spring:message code="label.defecttype" /><span
									class="required">*</span> <form:input path="edefecttype"
										class="textbox" maxlength="50" /></td>	
								</tr>
