...
function dateFun(datePattern) {
		$('#paiddate,#paiddateedit').datepicker({
													...
													.validate(
															{
																...
																messages : {
																	empadvId:"<font style='color: red;'><b>Employee Advance is Required</b></font>",
																	paidamount : {
																		required:"<font style='color: red;'><b>Paid Amount is Required</b></font>",
																		number : "<font style='color: red;'><b>Only numerics are allowed.</b></font>",
																	},
																	paiddate: {
																		required:"<font style='color: red;'><b>Paid Date is Required</b></font>",
																		number : "<font style='color: red;'><b>Only numerics are allowed.</b></font>",
																	},
																	month: {
...
<body>
	<div class="divUserDefault">
		<div class="PageTitle">Employee Advance Payments</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					<form:form action="searchEap.mnt" method="GET"
						commandName="EAP">
						<table class="tableGeneral">
							<tr>
								<td colspan="2"><c:forEach var="codeGroupAdd"
										...
										<div class="alert-success" id="savemessage">
											...
											<spring:message code="label.eap"/> <spring:message code="label.saveSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:if test="${param.listwar!=null }">							
								...
								<spring:message code="label.eap"/>	<spring:message code="label.saveFail"/>
										</div>	</c:if>
								<c:forEach var="accountGroupUpdate"
										items="${accountGroupUpdate}">
										<div class="alert-success" id="successmessage">
											<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.eap"/> <spring:message code="label.updateSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:forEach var="accountGroupUpdateError"
										...
										<div class="alert-danger" id="successmessage">
											<strong><spring:message code="label.error"/></strong>
											<spring:message code="label.eap"/> <spring:message code="label.updateFail"></spring:message>
										</div>
									</c:forEach><c:forEach var="accountGroupDelete"
										items="${accountGroupDelete}">
										<div class="alert-success" id="successmessage">
										<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.eap"/> <spring:message code="label.deleteSuccess"></spring:message>
										</div>
									</c:forEach><c:forEach var="accountGroupDeleteError"
										items="${accountGroupDeleteError}">
										<div class="alert-danger" id="successmessage">
										<strong><spring:message code="label.error"/></strong>
											<spring:message code="label.eap"/> <spring:message code="label.deleteFail"></spring:message>
										</div>
									</c:forEach></td>
							</tr>
							...
							<tr>
								...
								<form:select path="xmlLabel" cssClass="select">
									...
									<spring:bind path="EAP.operations">
					...
					<c:if test="${eaBeans!=null}">
						<display:table id="eapid" name="eaBeans"
							requestURI="searchEap.mnt" pagesize="5" class="table">
							<display:column property="eapId" title="EAPID"
								media="none" sortable="true"></display:column>
							<display:column property="empadvId"
								titleKey="label.empadv" media="html" sortable="true"></display:column>
								<display:column property="paidamount"
								titleKey="label.paymentamount" media="html" sortable="true"></display:column>
								<display:column property="paiddate"
								titleKey="label.paymentdate" media="html" sortable="true"></display:column>
							...
							<c:when test="${edit }">
								<a
									href="eapEdit.mnt?eapedit=<c:out value="${eapid.eapId}"/>"
							...
							<c:choose>
							<c:when test="${delete}">
								<a href="eapDelete.mnt?eapdelete=<c:out value="${eapid.eapId}"/>"
									style="color: red"
			...
			<div id="tabs-3" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					...
					<form:form action="saveeap.mnt" id="addaccountform"
						method="POST" commandName="EAP">
						<table class="tableGeneral">
							...
							<tr>
								<td><spring:message code="label.empadv" /><span
									class="required">*</span> </td><td> <form:select path="empadvId" id="empadvId" class="select">
										<form:option value="">--Select--</form:option>
								         <form:options items="${empAdvIds}" />
								</form:select></td>
							</tr>
							<tr>
								<td><spring:message code="label.paymentamount" /><span
									class="required">*</span> </td><td> <form:input path="paidamount"
										id="paidamount" class="textbox" maxlength="50" /></td>
							</tr>
							<tr>
								<td><spring:message code="label.paymentdate" /><span
									class="required">*</span> </td><td> <form:input path="paiddate"
										id="paiddate" class="textbox" maxlength="50" /></td>
							</tr>
							<tr>
			...
			<div id="tabs-1" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					<c:forEach var="AccountEditValues" items="${editvalues }">
						<form:form action="eappUpdate.mnt" method="POST"
							commandName="EAP" id="editaccountForm">
							<table class="tableGeneral">

								
								<form:hidden path="eapId" />
								<tr>
								<td><spring:message code="label.empadv" /><span
									class="required">*</span> </td><td> <form:select path="empadvId" class="select">
										<form:option value="">--Select--</form:option>
								         <form:options items="${empAdvIds}" />
								</form:select></td>
							</tr>
							...
							<tr>
								<td><spring:message code="label.paymentdate" /><span
									class="required">*</span> </td><td> <form:input path="paiddate"
										id="paiddateedit" class="textbox" maxlength="50" /></td>
							</tr>
							<tr>
								<td><spring:message code="label.month" /><span
									class="required">*</span> </td><td> <form:input path="month"
