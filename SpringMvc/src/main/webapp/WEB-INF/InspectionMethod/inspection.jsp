													...
													.validate(
															{
																...
																messages : {
																	inspectionmethod : {
																		required: "<font style='color: red;'><b>Inspection method is Required</b></font>",
...
<body>
	<div class="divUserDefault">
		<div class="PageTitle">Inspection Method</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
						...
						<tr>
								<td colspan="2"><c:forEach var="insmethodAdd"
										...
										<div class="alert-success" id="savemessage">
											...
											<spring:message code="label.inspectionmethod"/> <spring:message code="label.saveSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:if test="${param.listwar!=null }">							
								...
								<spring:message code="label.inspectionmethod"/>	<spring:message code="label.saveFail"/>
										</div>	</c:if>
								<c:forEach var="InspectionMethodUpdate"
										items="${InspectionMethodUpdate}">
										<div class="alert-success" id="successmessage">
											<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.inspectionmethod"/> <spring:message code="label.updateSuccess"></spring:message>
										</div>
									</c:forEach>
							<c:forEach var="InspectionMethodUpdateError"
										items="${InspectionMethodUpdateError}">
										<div class="alert-danger" id="successmessage">
											<strong><spring:message code="label.error"/></strong>
											<spring:message code="label.inspectionmethod"/> <spring:message code="label.updateFail"></spring:message>
										</div>
									</c:forEach><c:forEach var="inspectionMethodDelete"
										items="${inspectionMethodDelete}">
										<div class="alert-success" id="successmessage">
										<strong><spring:message code="label.success"/></strong>
											<spring:message code="label.inspectionmethod"/> <spring:message code="label.deleteSuccess"></spring:message>
										</div>
									</c:forEach><c:forEach var="inspectionMethodDeleteError"
										items="${inspectionMethodDeleteError}">
										<div class="alert-danger" id="successmessage">
										<strong><spring:message code="label.error"/></strong>
							...
							<tr>
								...
								<td><form:select path="xmlLabel" cssClass="select">
									...
									</form:select> <spring:bind path="InspectionMethod.operations">
					...
					<c:if test="${inspectionMethodBeans!=null}">
						<display:table id="inspectionid" name="inspectionMethodBeans"
							...
							<display:column property="inspectionmethod" titleKey="label.inspectionmethod"
						...
						<tr>
							<td colspan="2"><c:forEach var="inspectionsuccessdup"
									...
									<div class="alert-warning" id="savemessage">
											...
											<spring:message code="label.inspectionmethod"/> <spring:message code="label.duplicateCheck"></spring:message>
										</div>
								</c:forEach></td>
						</tr>
				...
				<div align="left" class="TabbedPanelsContent">
					<c:forEach var="InspectionMethodEditValues" items="${editvalues }">
						<form:form action="inspectionMethodUpdate.mnt" method="POST"
							...
							<table class="tableGeneral">
							<c:forEach var="inspectionsuccessdupedit"
