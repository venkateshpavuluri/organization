...
<body>
	...
	<div class="divUserDefault" id="mainId">
		<div class="PageTitle">Loan Type</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					<form:form action="searchLoanType.mnt" method="GET"
						commandName="loanTypeCmd">
						<table class="tableGeneral">
							<tr>
								<td colspan="2"><c:forEach items="${param.list}">
										<div class="alert-success">
											...
											<spring:message code="label.loanType" />
									...
									</c:forEach> <c:forEach items="${LoanTypeUpdate}">
										<div class="alert-success">
											<strong> <spring:message code="label.success" />
											</strong>
											<spring:message code="label.loanType" />
									...
									</c:forEach> <c:forEach items="${LoanTypeUpdateFail}">
										<div class="alert-danger">
											<strong> <spring:message code="label.error" />
											</strong>
											<spring:message code="label.loanType" />
									...
									</c:forEach> <c:forEach items="${LoanTypeDelete}">
									...
									</c:forEach> <c:forEach items="${LoanTypeDeleteFail}">
										<div class="alert-danger">
											<strong> <spring:message code="label.error" />
											</strong>
											<spring:message code="label.loanType" />
							...
							<tr>
								...
								<td><form:select path="xmlLabel" cssClass="select">
									...
									</form:select> <spring:bind path="loanTypeCmd.operations">
					...
					<c:if test="${loanBeans!=null}">
						<display:table id="Row" name="loanBeans"
							requestURI="searchLoanType.mnt" pagesize="5" class="table">
							<display:column property="loanType" titleKey="label.loanType"
							...
							<display:column titleKey="label.edit" style="color:white">
								<c:choose>
									<c:when test="${true}">
										...
										<a
											href="editLoanType.mnt?loanTypeId=<c:out value="${Row.loanTypeId}"/>"
							...
							<display:column titleKey="label.delete">
								<c:choose>
									<c:when test="${true}">
										<a
											href="deleteLoanType.mnt?loanTypeId=<c:out value="${Row.loanTypeId}"/>"
											style="color: red"
			...
			<div id="tabs-3" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					<form:form action="addLoanType.mnt" id="addForm" method="POST"
						commandName="loanTypeCmd">
						<table class="tableGeneral">
							...
							<tr>
								<td><spring:message code="label.loanType" /><span
									class="required">*</span></td>
								<td><form:input path="loanType" class="textbox" /></td>
							</tr>
			...
			<div id="tabs-1" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					<c:forEach var="AccountEditValues" items="${editvalues }">
						<form:form action="updateLoanType.mnt" method="POST"
							commandName="loanTypeCmd" id="editForm">
							<table class="tableGeneral">
								<tr>
								...
								<tr>
									<form:hidden path="loanTypeId" class="textbox" />
								</tr>
								<tr>
									<td></td>
									<td><c:choose>
