...
function popitup(x) {
		...
		url='generateAgreementListReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Agreement List Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateAgreementListReport.mnt" id="crReport"
						method="GET" commandName="agCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.agreementNo" /><font
									color="red"><strong>*</strong></font>:</td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${aggrement}" />
									</form:select></td>
							</tr>
							<tr>
