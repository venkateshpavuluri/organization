		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Vacancy Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateApplicantReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">All Applicants Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateApplicantReport.mnt" id="crReport"
						method="GET" commandName="appCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.vacancyNo" /><font
