...
function popitup(x) {
	if(x==''){
		...
		url='generateEmpsReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">All Employees Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateEmpsReport.mnt" id="crReport"
						method="GET" commandName="empCmd">
