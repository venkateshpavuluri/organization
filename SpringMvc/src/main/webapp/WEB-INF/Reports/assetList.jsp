		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Serial Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateAssetListReport.mnt?reportId='+x;
		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateAssetListReport.mnt" id="vrReport"
						method="GET" commandName="aCmd">
						<table class="tableGeneral">

							<tr>
							<td><s:message code="label.serialNumber" /><font
									color="red"><strong>*</strong></font>:</td>
								<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${asset}" />
									</form:select></td>
							</tr>
							<tr>
