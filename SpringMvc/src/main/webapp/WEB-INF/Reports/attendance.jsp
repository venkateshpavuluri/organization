...
<!--
	...
	if(x=='' || y==''){
		...
		.validate(
				{
					...
					messages : {
						...
						reportDate:"<font style='color: red;'><b>Year is Required</b></font>"
		...
		url = 'generateAttendanceReport.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Attendance Report</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generateAttendanceReport.mnt" method="GET" commandName="attCmd" id="attd">
