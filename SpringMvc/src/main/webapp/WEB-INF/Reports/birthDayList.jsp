		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Organization Name is Required</b></font>",
						
					},

				});
	} else{
		url='generateBirthDayListReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">BirthDay List Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateBirthDayListReport.mnt" id="vrReport"
						method="GET" commandName="bCmd">
