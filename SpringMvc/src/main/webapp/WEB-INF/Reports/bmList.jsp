		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Break down Maintainence Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateBdmListReport.mnt?reportId='+x;
		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateBdmListReport.mnt" id="crReport"
						method="GET" commandName="bdmCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.bdownno" /><font
									color="red"><strong>*</strong></font>:</td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${bm}" />
									</form:select></td>
							</tr>
							<tr>
