		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Break down Maintainence Logo Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateBdmLogoReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">BreakDown Maintainence List Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateBdmLogoReport.mnt" id="crReport"
						method="GET" commandName="bdmlCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.logNo" /><font
									color="red"><strong>*</strong></font>:</td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${bml}" />
									</form:select></td>
							</tr>
							<tr>
