...
<title>Vendor Invoice List</title>
<script language="javascript" type="text/javascript">
<!--
	function popitup(x, y) {
		url = 'generateCustomerInvoiceList.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Customer Invoice List</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generateCustomerInvoiceList.mnt" method="GET" commandName="ciReportCmd">
							<table class="tableGeneral">
								<tr>
									<td><s:message code="label.cino" /></td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${customerInvoice}" />
									</form:select></td>
								</tr>
								<tr>
									<td><s:message code="label.cid" /></td>
