		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Customer Invoice Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateCIReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Customer Invoice Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateCIReport.mnt" id="ciReport"
						method="GET" commandName="cipReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.cino" /><font
