...
<!--
	function popitup(x, y) {
		url = 'generateCustomerListReport.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Customer List</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generateCustomerListReport.mnt" method="GET" commandName="custListCmd">
							<table class="tableGeneral">
								<tr>
									<td><s:message code="label.custName" /></td>
