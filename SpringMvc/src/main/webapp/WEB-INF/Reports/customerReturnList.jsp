...
<!--
	function popitup(x, y) {
		url = 'generateCustomerReturnList.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Customer Return List</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generateCustomerReturnList.mnt" method="GET" commandName="crReportCmd">
							<table class="tableGeneral">
								<tr>
									<td><s:message code="label.CustomerReturnNo" /></td>
								...
								<tr>
									<td><s:message code="label.CustomerReturnDate" /></td>
