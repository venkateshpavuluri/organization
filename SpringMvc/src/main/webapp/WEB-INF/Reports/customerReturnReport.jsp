		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Customer Return Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateCRReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Customer Return Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateCRReport.mnt" id="crReport"
						method="GET" commandName="crpReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.CustomerReturnNo" /><font
									color="red"><strong>*</strong></font>:</td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${customerReturn}" />
									</form:select></td>
							</tr>
							<tr>
