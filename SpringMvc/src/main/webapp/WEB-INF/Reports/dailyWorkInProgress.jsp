		...
		$('#workInProgress').validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Shift is Required</b></font>",
						reportDate : "<font style='color: red;'><b>Work Day  is Required</b></font>",
						
					},

				});
	} else {
		url = 'generatdwpReport.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Dialy Work in Progress</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generatdwpReport.mnt" method="GET" commandName="dwpCmd" id="workInProgress">
							<table class="tableGeneral">
							<tr>
									<td><s:message code="label.shift" /></td>
									<td><input type="text" name="reportId" id="reportId" class="textbox" /></td>
								</tr>
								<tr>
									<td><s:message code="label.insplotorigin" /></td>
