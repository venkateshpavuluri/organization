...
function popitup(x) {
	if(x==''){
		...
		url='generateDeliveryNoteReport.mnt?soNo='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Delivery Note Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateDeliveryNoteReport.mnt" id="salesOrder"
						method="GET" commandName="dnCmd">
