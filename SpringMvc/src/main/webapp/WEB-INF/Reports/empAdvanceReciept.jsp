		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Employee Name is Required</b></font>",
						
					},

				});
	} else{
		url='generateEmparReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Employee Advance Reciept Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateEmparReport.mnt" id="crReport"
						method="GET" commandName="emparCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.empName" /><font
