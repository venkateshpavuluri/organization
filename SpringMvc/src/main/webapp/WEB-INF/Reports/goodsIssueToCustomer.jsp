		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Sales Order Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateGISReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Goods Issue To Customer Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateGISReport.mnt" id="salesOrder"
						method="GET" commandName="gisReportCmd">
