...
function popitup(x) {
	if(x==''){
		...
		url='generateGIPReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Goods Issue To Production</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateGIPReport.mnt" id="gip"
						method="GET" commandName="gipReportCmd">
