		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Year is Required</b></font>",
						
					},

				});
	} else{
		url='generateHolidayListReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Holidays Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateHolidayListReport.mnt" id="vrReport"
						method="GET" commandName="hCmd">
						<table class="tableGeneral">

							<tr>
								<td>Enter Year(yyyy)<font
