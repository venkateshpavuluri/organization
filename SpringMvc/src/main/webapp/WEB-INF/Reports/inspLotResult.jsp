...
function popitup(x) {
		...
		url='generateInspectionLotResultReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Agreement Line Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateInspectionLotResultReport.mnt" id="crReport"
						method="GET" commandName="iLRCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.insplno" /><font
									color="red"><strong>*</strong></font>:</td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${inspLotNot}" />
									</form:select></td>
							</tr>
							<tr>
