...
<!--
	function popitup(x, y) {
		url = 'generatePhysicalVerificationList.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Vendor Return List</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generatePhysicalVerificationList.mnt" method="GET" commandName="pvReportCmd">
							<table class="tableGeneral">
								<tr>
									<td><s:message code="label.verificationNo" /></td>
								...
								<tr>
									<td><s:message code="label.verificationDate" /></td>
