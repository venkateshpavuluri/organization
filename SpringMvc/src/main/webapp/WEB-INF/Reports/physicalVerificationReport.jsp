		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Verification Number is Required</b></font>",
						
					},

				});
	} else{
		url='generatePVReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Physical Verification Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generatePVReport.mnt" id="pvReport"
						method="GET" commandName="pvpReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.verificationNo" /><font
									color="red"><strong>*</strong></font>:</td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${physicalVerification}" />
									</form:select></td>
							</tr>
							<tr>
