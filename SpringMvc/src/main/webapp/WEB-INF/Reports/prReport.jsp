			...
			$('#prReport').validate(
					{
						...
						messages : {
							prNo : "<font style='color: red;'><b>Purchase Requisition Number is Required</b></font>",
							
						},

					});
		} else {
			url = 'generatePRReportWithChild.mnt?prNo='+ x;
			newwindow = window
					.open(
							url,
							'name',
		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form  id="prReport" method="GET" commandName="prReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.prNo" /><font
							...
							<tr>
								<td colspan="2"><input type="submit" value="<s:message code="label.reportSubmit" />"
									 class="btn btn-primary" onclick="return popitup(document.getElementById('prNo').value)" /></td>
							</tr>
						</table>
					</form:form>
				</div>
