...
function popitup(x) {
	if(x==''){
		...
		url='generateReceiptReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Receipt Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateReceiptReport.mnt" id="receipt"
						method="GET" commandName="rReportCmd">
