...
function popitup(x) {
		...
		$('#rfqReport').validate(
				{
					...
					messages : {
						rNo : "<font style='color: red;'><b>RFQ Number is Required</b></font>",
	...
	url='generateRFQReportWithChild.mnt?rNo='+x;
		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateRFQReportWithChild.mnt" id="rfqReport" method="GET" commandName="rfqReportCmd">
						<table class="tableGeneral">
							...
							<tr>
								<td colspan="2"><input type="submit" value="<s:message code="label.reportSubmit" />"
									id="subid" class="btn btn-primary" onclick="return popitup(document.getElementById('rNo').value)" /></td>
							</tr>
						</table>
					</form:form>
				</div>
