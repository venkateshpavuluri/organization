		...
		.validate(
				{
					...
					messages : {
						soNo : "<font style='color: red;'><b>Sales Order Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateSalesOrderPwcReport.mnt?soNo='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Sales Order Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateSalesOrderPwcReport.mnt" id="salesOrder"
						method="GET" commandName="soReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.soNo" /><font
							...
							<tr>
								<td colspan="2"><input type="submit" value="<s:message code="label.reportSubmit" />"
									id="subid" class="btn btn-primary" onclick="return popitup(document.getElementById('soNo').value)" /></td>
							</tr>
						</table>
					</form:form>
				</div>
