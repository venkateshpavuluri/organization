...
<!--
	function popitup(x, y) {
		url = 'generateStockTransferList.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Stock Transfer List</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generateStockTransferList.mnt" method="GET" commandName="stReportCmd">
							<table class="tableGeneral">
								<tr>
									<td><s:message code="label.strno" /></td>
								...
								<tr>
									<td><s:message code="label.strdate" /></td>
