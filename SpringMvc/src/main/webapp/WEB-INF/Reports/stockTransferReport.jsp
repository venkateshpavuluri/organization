		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Stock Transfer Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateSTReport.mnt?reportId='+x;
...
<body>
	<div id="userdefault" align="left">
		<div class="PageTitle">Stock Transfer Report</div>
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateSTReport.mnt" id="stReport"
						method="GET" commandName="stpReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.strno" /><font
									color="red"><strong>*</strong></font>:</td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${stockTransfer}" />
									</form:select></td>
							</tr>
							<tr>
