...
<!--
	function popitup(x, y) {
		url = 'generateVendorInvoiceList.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
...
<body>
	<div id="userdefault" align="left">
		<div id="userdefault" align="left">
			<div class="PageTitle">Vendor Invoice List</div>
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generateVendorInvoiceList.mnt" method="GET" commandName="viReportCmd">
							<table class="tableGeneral">
								<tr>
									<td><s:message code="label.vino" /></td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${vendorInvoice}" />
									</form:select></td>
								</tr>
								<tr>
									<td><s:message code="label.vid" /></td>
