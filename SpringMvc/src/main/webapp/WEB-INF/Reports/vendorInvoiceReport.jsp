		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Vendor Invoice Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateVIReport.mnt?reportId='+x;
		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateVIReport.mnt" id="viReport"
						method="GET" commandName="vipReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.vino" /><font
