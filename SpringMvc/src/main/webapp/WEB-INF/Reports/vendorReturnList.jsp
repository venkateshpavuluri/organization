...
<!--
	function popitup(x, y) {
		url = 'generateVendorReturnList.mnt?reportId=' + x + '&reportDate=' + y;
		newwindow = window
				.open(
						url,
						'name',
			...
			<div id="tabs" class="TabbedPanels">
				...
				<div id="tabs-2" class="TabbedPanelsContent">
					<div align="left">
						...
						<form:form action="/generateVendorReturnList.mnt" method="GET" commandName="vrReportCmd">
							<table class="tableGeneral">
								<tr>
									<td><s:message code="label.vendorreturnno" /></td>
									<td><form:select path="reportId"
										class="select">
										<form:option value="">-Select-</form:option>
										<form:options items="${vendorReturn}" />
									</form:select></td>
								</tr>
								<tr>
									<td><s:message code="label.vendorreturndate" /></td>
