		...
		.validate(
				{
					...
					messages : {
						reportId : "<font style='color: red;'><b>Vendor Return Number is Required</b></font>",
						
					},

				});
	} else{
		url='generateVRReport.mnt?reportId='+x;
		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					...
					<form:form action="/generateVRReport.mnt" id="vrReport"
						method="GET" commandName="vrpReportCmd">
						<table class="tableGeneral">

							<tr>
								<td><s:message code="label.vendorreturnno" /><font
