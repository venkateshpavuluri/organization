													...
													.validate(
															{
																...
																messages : {
																	skill : {
																		required:"<font style='color: red;'><b>Skill is Required</b></font>",
	...
	<div class="divUserDefault">
		...
		<div id="tabs" class="TabbedPanels">
			...
			<div id="tabs-2" class="TabbedPanelsContent">
				<div align="left">
					<form:form action="searchskill.mnt" method="GET"
						commandName="skill">
						<table class="tableGeneral">
							<tr>
								<td colspan="2"><c:forEach 
                                      ...
                                      <spring:message code="label.skill"/>  <spring:message code="label.saveSuccess"/>
										</div>
									</c:forEach>
									...
									<c:forEach 
                                      ...
                                      <spring:message code="label.skill"/>  <spring:message code="label.saveFail"/>
										</div>
									</c:forEach>
									

                                    <c:forEach items="${SkillUpdate}">
										<div class="alert-success" >
											<strong> <spring:message code="label.success"/> </strong>
                                      <spring:message code="label.skill"/>  <spring:message code="label.updateSuccess"/>
										</div>
									</c:forEach>
									
									 <c:forEach items="${SkillUpdateFail}">
										<div class="alert-danger" >
											<strong> <spring:message code="label.error"/> </strong>
                                      <spring:message code="label.skill"/>  <spring:message code="label.updateFail"/>
										</div>
									</c:forEach>
									
									<c:forEach items="${SkillDelete}">
										<div class="alert-success" id="successmessage">
											<strong> <spring:message code="label.success"/> </strong>
                                      <spring:message code="label.skill"/>  <spring:message code="label.deleteSuccess"/>
										</div>
									</c:forEach>
										<c:forEach items="${SkillDeleteFail}">
											<div class="alert-danger" >
											<strong> <spring:message code="label.error"/> </strong>
                                      <spring:message code="label.skill"/>  <spring:message code="label.deleteFail"/>
										</div>
									</c:forEach>
							...
							<tr>
								...
								<form:select path="xmlLabel" cssClass="select">
									...
									<spring:bind path="skill.operations">
...
<c:forEach var="skillValues" items="${skillValues}">
						<c:set var="g" value="${skillValues}"></c:set>
					</c:forEach>
					<c:if test="${g!=null}">
					
					
						<display:table id="skillRow" name="licenceBeans"
							requestURI="searchskill.mnt" pagesize="5" class="table">
							<display:column property="skill" titleKey="label.licence"
							...
							<c:when test="${edit}">
								...
								<a
									href="skilledit.mnt?skilledit=<c:out value="${skillRow.skillId}"/>"
							...
							<c:when test="${delete }">
								<a
									href="skillDelete.mnt?skillDelete=<c:out value="${skillRow.skillId}"/>"
									style="color: red"
			...
			<div id="tabs-3" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					...
					<form:form action="skillAdd.mnt" id="addskillform"
						method="POST" commandName="skill">
						<table class="tableGeneral">
							...
							<tr>
								<td colspan="2"><c:forEach var="AGSuccessdup"
										...
										<div class="alert-warning" id="successmessage">
											...
											<spring:message code="label.skill"/> <spring:message code="label.duplicateCheck"/>
										</div>
									</c:forEach></td>
							</tr>
							...
							<tr>
								<td><spring:message code="label.skill" /><span
									class="required">*</span></td><td> <form:input path="skill"
										id="skill" class="textbox" maxlength="50"/></td>
							</tr>
							<tr>
								<td colspan="2">
								<c:choose>
			...
			<div id="tabs-1" class="TabbedPanelsContent">
				<div align="left" class="TabbedPanelsContent">
					<c:forEach var="AccountEditValues" items="${editvalues }">
						<form:form action="skillUpdate.mnt" method="POST"
							commandName="skill" id="editskillForm">
							<table class="tableGeneral">
								...
								<tr>
									<td><spring:message code="label.skill" /><span
										class="required">*</span></td><td> <form:input path="skillEdit" id="skillEdit"
								...
								<tr>
									...
									<input type="submit" value="<spring:message code="label.update"/>"
										...
										<c:otherwise>
										<input type="submit" disabled="disabled" value="<spring:message code="label.update"/>"
