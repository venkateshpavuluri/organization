													...
													.validate(
															{
																...
																messages : {
																	itemCategoryEditt : "<font style='color: red;'><b>Item Category is Required</b></font>"
																},
															});
				...
				<div align="left">
					...
					<form:form action="itemCategorySearch.mnt" method="GET"
						...
						<table class="tableGeneral">
							<tr>
								<td colspan="2"><c:forEach var="itemCategoryUpadted"
										items="${param.list}">
							...
							<tr>
								<td colspan="2"><c:forEach var="itemCategoryUpadted"
										items="${itemCategoryUpadte}">
										<div class="alert-success" id="successmessage">
											<strong>Success!</strong>
											<c:out value="${itemCategoryUpadted}"></c:out>
										</div>
									</c:forEach></td>
							</tr>
							<tr>
								<td colspan="2"><c:forEach var="itemUpadted"
										items="${param.list1}">
							...
							<%-- <tr>
								...
								<td><form:input path="itemCategoryId" cssClass="textbox"/></td>
					...
					<c:forEach var="itemCategorySearch" items="${itemCategorySearch}">
						<c:set var="g" value="${itemCategorySearch}"></c:set>
					</c:forEach>
					<c:if test="${g!=null}">
						<display:table id="itemCategoryValue" name="itemCategorySearch"
							requestURI="itemCategorySearch.mnt" pagesize="5" class="table">

							<display:column property="itemCategory" title="Item Category"
						...
						<table class="tableGeneral" >
							...
							<tr>
								<td colspan="2" height="20px"><c:forEach
										var="addItemDuplicate" items="${addItemDuplicate}">
										<div class="alert-warning" id="savemessage">
											<font color="red"><c:out value="${addItemDuplicate}" /></font>
										</div>
									</c:forEach></td>
							</tr>
							<tr>
								<td>Item Category<font color="red">*</font>
								</td>
							...
							<table class="tableGeneral">
								...
								<tr>
									...
									<td><form:input path="itemCategoryEditt"
											id="itemCategoryEditt" class="textbox" /></td>
								</tr>
								<tr>
