...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <form:input path="userName"   onblur="if(this.value=='') this.value='Username';" onfocus="if(this.value=='Username') this.value='';" />
    </div></td>
    </tr>
  <tr>
    <td colspan="2"><div class="log-bottom">
 <form:password path="password"  onblur="if(this.value=='') this.value='Password';" onfocus="if(this.value=='Password') this.value='';" />
    </div></td>
    </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td align="right"><input type="submit" class="login-btn" value="Login" /></td>
  </tr>
</table>
</div>
<div><center><h4 style="color: RED">Invalid Username Password</h4> </center> </div>
<!--Footer-->
